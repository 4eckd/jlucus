...
export function HeroTerminal() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex w-full items-center justify-center px-8 py-20 lg:w-1/2">
        <motion.div
      ...
      <div className="relative hidden items-center justify-center overflow-hidden lg:flex lg:w-1/2">
        ...
        {/* Terminal Window */}
        <motion.div
          className="terminal-box bg-background-secondary/80 border-primary/10 shadow-neon-primary-lg relative z-10 mx-8 w-full max-w-lg overflow-hidden rounded-lg border backdrop-blur-sm"
          variants={itemVariants}
        >
          {/* Terminal Header */}
      ...
      <div className="pointer-events-none absolute inset-0 z-0 opacity-30 lg:hidden">
        <AnimatedGrid />
      </div>
