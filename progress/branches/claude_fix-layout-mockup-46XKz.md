# Branch: claude/fix-layout-mockup-46XKz
...
- 4e6e9a9 feat: implement 50/50 split layout for Hero and About panel in Skills (Claude, 36 seconds ago)
- bf0db1f chore: update branch tracking manifest [skip ci] (github-actions[bot], 5 minutes ago)
- 612849a chore: remove superseded config files replaced by js/mjs equivalents (Claude, 5 minutes ago)
- 049766d chore: update branch tracking manifest [skip ci] (github-actions[bot], 44 minutes ago)
- dbe8bf8 Merge pull request #150 from 4eckd/claude/setup-git-workflow-Kh0iS (SupItsJ, 45 minutes ago)
...
D	next.config.ts
D	postcss.config.js
A	progress/branches/claude_fix-layout-mockup-46XKz.md
...
A	src/components/effects/index.ts
